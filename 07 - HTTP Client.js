...
http.get(process.argv[2], response => {
  ...
  response.on("error", error => {
    console.log("Unable to make the GET request", error);
  });
});
...
//       response.on('data', console.log) // This is very clever. data will be passed to any callback provided. Using console.log() as callback is clever.
